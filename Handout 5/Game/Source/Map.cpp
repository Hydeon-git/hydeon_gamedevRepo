...
bool Map::LoadMap()
{
	...
	else
	{
		...
		data.tileHeight = map.attribute("tilewidth").as_int();		
	}
	return ret;
}
...
bool Map::LoadTilesetDetails(pugi::xml_node& tileset_node, TileSet* set)
{
	...
	SString name = tileset_node.attribute("name").as_string();
	set->tileWidth = tileset_node.attribute("titlewidth").as_int();
	set->tileHeight = tileset_node.attribute("titleheight").as_int();
